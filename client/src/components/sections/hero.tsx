        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="space-y-12 animate-fade-in">
            ...
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-gradient-to-r from-blue-50 to-purple-50 border border-blue-100">
              <span className="text-sm font-medium text-blue-700">AI-Powered DevOps Platform</span>
            </div>
            
            <div className="space-y-8">
              <h1 className="text-6xl lg:text-7xl font-bold text-gray-900 leading-[1.1] tracking-tight">
                Deploy Production-Ready
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Infrastructure</span>
                in Minutes
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              ...
              <Button variant="outline" className="border border-gray-200 text-gray-700 px-8 py-4 rounded-xl hover:bg-gray-50 transition-all duration-300 font-medium text-lg">
            ...
            <div className="flex items-center space-x-8 pt-4">
              ...
              <div className="flex items-center space-x-2">
                <Check className="h-5 w-5 text-emerald-500" />
                <span className="text-gray-600 font-medium">5-minute setup</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative">
              ...
              <div className="bg-white rounded-3xl shadow-2xl p-8 border border-gray-100">
                ...
                <div className="flex items-center justify-between mb-8">
                  ...
                  <div className="text-sm text-gray-500 font-mono">omniinfra.dev</div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4">
                      <div className="text-sm text-blue-600 font-medium">Deployments</div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4">
                      <div className="text-sm text-purple-600 font-medium">Saved</div>
                      <div className="text-2xl font-bold text-purple-900">127h</div>
                    </div>
                  </div>
              ...
              <div className="absolute -bottom-4 -left-4 bg-white rounded-xl p-3 shadow-lg border border-gray-100">
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-xs font-medium text-gray-700">Auto-scaling active</span>
                </div>
              </div>
            </div>
          </div>
